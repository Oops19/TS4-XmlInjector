...
An updated version of Scumbumbo’s XML Injector, refactored for modern modding workflows and enhanced with S4CL-based logging.

The compatibility version of this injector is 4 — independent of the GitHub release version.

## 🔄 Compatibility

This mod is not compatible with the original XML Injector.
Use either the original or this version — not both.

🧪 Refactoring Highlights

* All global methods and parameters have been encapsulated into classes.
* Logging now uses S4CL, providing structured and readable output.
* Legacy injection methods, including those tied to `on_loading_screen_animation_finished`, have been removed.

Original source code by Scumbumbo is available at https://gitlab.com/scumbumbo/xml-injector/-/tree/master
